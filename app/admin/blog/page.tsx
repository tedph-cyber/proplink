    ...
    <div className={styles.pageNarrow}>
      ...
      <div className={styles.pageHeaderRow}>
        <div>
          ...
          <p className={styles.pageSubtitle}>Curate and manage your market insights and guides.</p>
        </div>
        <Link href="/admin/blog/new" className={styles.submitBtn + ' flex items-center gap-3'}>
              ...
              <tr>
                <td colSpan={5}>
                  <div className="flex flex-col items-center justify-center min-h-[360px] px-8">
                    ...
                    <h2 className="text-xl font-bold text-[var(--color-text)] mb-2">No blog posts yet</h2>
                    ...
                    <Link
                      href="/admin/blog/new"
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[var(--color-accent)] text-white font-bold text-sm hover:opacity-90 transition-opacity"
                    >
